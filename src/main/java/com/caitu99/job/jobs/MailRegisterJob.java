 ...
 * @ClassName: MailRegisterJob 
 * @author ws
 * @date 2015年12月17日 下午3:04:25 
 * @Copyright (c) 2015-2020 by caitu99
 */
@PersistJobDataAfterExecution
@DisallowConcurrentExecution
public class MailRegisterJob implements Job {
	private static final Logger logger = LoggerFactory.getLogger(MailRegisterJob.class);
